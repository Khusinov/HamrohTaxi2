package com.khusinov.hamrohtaxi.adapter
...
import com.khusinov.hamrohtaxi.databinding.ItemMyPostBinding
import com.khusinov.hamrohtaxi.databinding.ItemPostBinding
import com.khusinov.hamrohtaxi.models.Post


class MyPostAdapter() : RecyclerView.Adapter<MyPostAdapter.PartOneViewHolder>() {

    private val dif = AsyncListDiffer(this, ITEM_DIFF)

    var onClick: ((Post) -> Unit)? = null
    var onClick2: ((Post) -> Unit)? = null

    private val TAG = "PostAdapter"

    inner class PartOneViewHolder(private val binding: ItemMyPostBinding) :
